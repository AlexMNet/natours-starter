...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWxleG1uZXQiLCJhIjoiY2trcW5qbWc4MDMzdzJwcDY0bTRiamNoaSJ9.qgsYHjngiVOt9keWynHojQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/alexmnet/ckxs8u6s8tasc15luke27wiak',
    // style URL
    scrollZoom: false,
    center: [-74.5, 40],
