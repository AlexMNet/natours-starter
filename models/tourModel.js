...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      unique: true,
      trim: true,
      maxlength: [40, 'A tour name must have less or equal oto 40 characters'],
    ...
    difficulty: {
      ...
      enum: {
        ...
        message: 'Difficultys is either: easy, medium or difficult'
      }
    },
    ratingsAverage: {
      type: Number,
      ...
      set: val => Math.round(val * 10) / 10 //Rounding to the 10ths place
    },
    ratingsQuantity: {
      type: Number,
      default: 0
    ...
    summary: {
      type: String,
      trim: true,
      required: [true, 'Tour Musc have a summary']
    },
    description: {
      type: String,
      trim: true
